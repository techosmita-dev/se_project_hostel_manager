...
router.delete('/:_id', passport.authenticate('jwt', { session: false }), ensureAdmin, (req, res) => {
...
router.put('/availability/:id', passport.authenticate('jwt', { session: false }), ensureAdmin, (req, res) => {
  const { id } = req.params;
